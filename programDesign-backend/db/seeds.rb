...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    Workout.create(description: 'Push', warmUp: '', volume: 0, date: '2020-09-11',program_id: 1, exercise_id: [1,3,4])
    Workout.create(description: 'Pull', warmUp: '', volume: 0, date: '2020-09-11',program_id: 1, exercise_id: [2,5])
    Workout.create(description: 'Total Body', warmUp: '', volume: 0, date: '2020-09-11',program_id: 2, exercise_id: [1,2,3,4,5])
    Workout.create(description: 'Total Body', warmUp: '', volume: 0, date: '2020-09-11',program_id: 2, exercise_id: [1,2,3,4,5])
